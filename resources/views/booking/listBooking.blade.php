...
<body>
    ...
    <p><br></p>
        <h5 class="text-center"># Add Booking</h5>
    </div>

    <!-- Update Model -->
    <form action="" method="POST" class="booking-update-record-model form-horizontal">
            ...
            <div class="modal-dialog modal-dialog-centered" style="width:55%;">
                <div class="modal-content" style="overflow: hidden;">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-success updateBooking">Update
                        </button>
                    </div>
                </div>
            </div>
    ...
    <!-- Delete Model -->
    <form action="" method="POST" class="booking-remove-record-model">
    ...
    <script>
        ...
        $('#submitBooking').on('click', function () {
            ...
            firebase.database().ref('Booking/' + custID).set({
                name: name,
                email: email,
            });
