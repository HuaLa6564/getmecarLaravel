...
<body>
    ...
    {{View::make('layouts.header')}}
        <p><br></p>
        <h5 align="center">List of Employee</h5>
    ...
    <!-- Delete Model -->
    <form action="" method="POST" class="employee-remove-record-model">
    ...
    <script>
        ...
        $('body').on('click', '.updateData', function () {
            ...
            firebase.database().ref('Employee/' + updateID).on('value', function (snapshot) {
                ...
                var updateData = '<div class="form-group">\
                    <label for="first_name" class="col-md-12 col-form-label">Employee ID</label>\
                    <div class="col-md-12">\
        ...
        $('.updateEmployee').on('click', function () {
            ...
            var updates = {};
            updates['/Employee/' + updateID] = postData;
        ...
        $("body").on('click', '.removeData', function () {
            ...
            $('body').find('.employee-remove-record-model').append('<input name="id" type="hidden" value="' + id + '">');
        });

        $('.deleteRecord').on('click', function () {
            var values = $(".employee-remove-record-model").serializeArray();
            var id = values[0].value;
            firebase.database().ref('Employee/' + id).remove();
            $('body').find('.employee-remove-record-model').find("input").remove();
