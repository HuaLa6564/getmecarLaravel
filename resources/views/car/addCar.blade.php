...
<body>
    ...
    {{View::make('layouts.header')}}
        <h4 class="text-center">Car CRUD</h4><br>
        <h5># Add Car</h5>
        <!-- <div class="card card-default"> -->
            <!-- <div class="card-body"> -->
                <form id="addCar" class="form-inline" method="POST" action="">
                    <div class="form-group mb-2">
                        <input id="id" type="text" class="form-control" name="id" placeholder="Car ID" required autofocus>
                    </div>
                    <br>
                    <div class="form-group mx-sm-3 mb-2">
                        <input id="email" type="email" class="form-control" name="email" placeholder="Email"required autofocus>
                    </div>
                    <button id="submitCar" type="button" class="btn btn-primary mb-2">Submit</button>
                </form>
            <!-- </div>
        </div> -->
